    ...
    <select name="producto";>
        <?php
            do{
                ...
                $marca=$reg['marca'];
        ?>
        <option value=<?php echo $nombre?> <?php echo $precio?> <?php $stock ?> <?php $marca ?>
        </option>
        <?php
...
<?php
    if(isset($_post['actualizar'])){
        ...
        mysql_query("update categoria set nombre=$nombre,descripcion=$descripcion" where id)or die (mysql_connect);
